...
PYBIND11_MODULE(py_big_int_tc_wrap, module) {
    ...
    pybind11::class_<big_int_test_cases>(module, "big_int_tc")
        ...
        .def("bi_test_big_int_get_random_unsigned_between", &big_int_test_cases::bi_test_big_int_get_random_unsigned_between)
        .def("bi_test_big_int_get_random_unsigned_prime_rabin_miller_threaded", &big_int_test_cases::bi_test_big_int_get_random_unsigned_prime_rabin_miller_threaded);
