...
int main(int argc, char *argv[]) {
    ...
    std::string test_num_str_31 = "0";
    std::string test_num_str_32 = "-14a4c9dcf1bcb9ce45c64ab763aa184a774e6e9498b56d08bbcd82056023a3dfa7dd38ff91afa45c289ec970e456fa118d1b57c18d4b519a78fe40830";
